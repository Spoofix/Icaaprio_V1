...
interface RateTypeDistributionProps {
  data: RateTypeData[];
  totalValue: number;
}

const tooltipContent = {
  title: 'Rate Type Distribution',
  tooltip: 'Distribution of portfolio by interest rate type. Shows exposure to interest rate risk through rate type mix.'
};

export function RateTypeDistribution({ data, totalValue }: RateTypeDistributionProps) {
