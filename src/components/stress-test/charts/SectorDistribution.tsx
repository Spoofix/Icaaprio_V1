...
const tooltipContent = {
  ...
  tooltip: 'Distribution of business exposures across different industry sectors. Critical for assessing sector concentration risk. High exposure to specific sectors may increase vulnerability to sector-specific economic shocks.'
};

export function SectorDistribution({ data, totalValue }: SectorDistributionProps) {
