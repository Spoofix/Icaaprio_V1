...
const tooltipContent = {
  ...
  tooltip: 'Distribution of CRE portfolio across different property types. Shows exposure to specific real estate sectors.'
};

export function PropertyTypeDistribution({ data, totalValue }: PropertyTypeDistributionProps) {
